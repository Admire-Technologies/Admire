            ...
            <span style={{ 
              ...
              >
                ...
                {devices.map((device, index) => (
                  <div
                    key={device.name}
                    className={`device-icon ${currentDevice === index ? 'active' : ''}`}
                    style={{
                      transform: `
                        rotate(15deg) 
                  ...
                  >
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = device.name === 'laptop' ? '💻' : 
          ...
          <div className="hero-actions" style={{ 
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <span style={{ color: '#ff4d4d', fontSize: '14px', fontWeight: 'bold' }}>A</span>
              </div>
              <div style={{ display: 'flex', gap: '3px' }}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <span key={star} style={{ color: '#ff4d4d', fontSize: '16px' }}>★</span>
                ))}
              </div>
            </div>
          </div>
